...
namespace ItemBrowser.Utilities {
	public static class ObjectUtils {
		...
		public static int GetDisplayNameSortOrder(ObjectDataCD objectData) {
			return DisplayNameSortOrders.GetValueOrDefault(objectData);
		}
		
		public static int GetDisplayNameSortOrder(ObjectID id, int variation = 0) {
			return GetDisplayNameSortOrder(new ObjectDataCD { objectID = id, variation = variation });
		}
