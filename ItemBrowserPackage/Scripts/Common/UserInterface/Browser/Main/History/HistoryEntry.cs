...
namespace ItemBrowser.Common.UserInterface.Browser {
	public class HistoryEntry : ItemBrowserButton {
		...
		public void SetDetailsState(DetailsState state) {
			...
			_typeString = ObjectUtility.IsNonObtainable(state.ObjectData) ? $"ItemBrowser-DetailsTabs/{state.Tab}_NonObtainable" : $"ItemBrowser-DetailsTabs/{state.Tab}";
		...
		public override TextAndFormatFields GetHoverTitle() {
			return new TextAndFormatFields {
				...
				formatFields = new[] {
					ObjectUtility.GetLocalizedDisplayNameOrDefault(_state.ObjectData)
				},
		...
		public override List<TextAndFormatFields> GetHoverDescription() {
			return new List<TextAndFormatFields> {
				...
				new() {
					...
					color = UserInterfaceUtility.DescriptionColor,
					paddingBeneath = UserInterfaceUtility.DescriptionPadding
				},
				new() {
