...
namespace PinyinNet
{
    ...
    {
        private const string PinyinAssetPath = "Assets/ItemBrowser/ItemBrowserPackage/Text/Pinyin.txt";
        ...
        public static void Load()
        {
            if (_dict == null)
            {
                ...
                string[] strLines = Main.AssetBundle.LoadAsset<TextAsset>(PinyinAssetPath).text.Split(new[]
                {
                    '\r',
                    '\n'
