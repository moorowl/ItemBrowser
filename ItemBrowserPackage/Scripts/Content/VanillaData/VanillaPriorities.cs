namespace ItemBrowser.Content.VanillaData {
	public static class VanillaPriorities {
		...
		public const int CritterCatching = 7100;
		public const int Crafting = 7000;
		public const int Trading = 6900;
		public const int Fishing = 6800;
		public const int Merchant = 6700;
		public const int Bucketing = 6600;
		public const int VendingMachine = 6500;
